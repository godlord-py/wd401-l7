                ...
                <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" onClose={closeModal}>
                    ...
                    >
                        <div className="flex min-h-full items-center justify-center">
                            <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-lg bg-gray-300 text-white p-6 text-left align-middle shadow-xl transition-all dark:bg-black dark:border border-black border-4 bg-gradient-to-r from-blue-300 to-purple-300">
                                {articleDetails && (
                                    <>
                                        ...
                                        <div className="mt-4 bg-gray-300 -m-6 p-6 text-black dark:bg-black bg-gradient-to-r from-blue-3 00 to-purple-300">
                                            ...
                                            <div className="text-justify font-bold dark:text-neutral-400">
